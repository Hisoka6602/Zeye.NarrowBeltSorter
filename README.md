...
├── 包裹密集上车小车号偏差根因分析.md       # 高密度包裹场景下上车小车号偏差根因拆解（fire-and-forget乱序与BuildRing/Update竞争）
...
- 新增 `包裹密集上车小车号偏差根因分析.md`，深入分析高密度包裹场景下 CarrierId 更新乱序的根因（fire-and-forget 并发竞争 + BuildRing/Update 竞争时序）。
