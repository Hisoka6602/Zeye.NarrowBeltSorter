...
namespace Zeye.NarrowBeltSorter.Execution.Parcel {
    ...
    internal static partial class ParcelManagerLog {
        ...
        [LoggerMessage(EventId = 2330, Level = LogLevel.Information,
            Message = "包裹落格：ParcelId={ParcelId} BarCode={BarCode} ActualChuteId={ActualChuteId} CurrentInductionCarrierId={CurrentInductionCarrierId} DroppedAt={DroppedAt:o}")]
        public static partial void Dropped(ILogger logger, long parcelId, string? barCode, long actualChuteId, long? currentInductionCarrierId, DateTime droppedAt);
